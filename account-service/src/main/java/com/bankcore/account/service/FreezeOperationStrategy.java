...
@Component
public class FreezeOperationStrategy extends AbstractAccountOperationTemplate {
    ...
    public FreezeOperationStrategy(AccountRepository repository, AccountLedgerRepository ledgerRepository,
